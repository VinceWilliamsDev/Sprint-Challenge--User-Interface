...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    ...
    Semantic HTML is the use of different HTML tags to give meaning to the content of a page. 
...
4. Explain why git is valuable to a team of developers.
    ...
    It allows a team of developers to work independently but also collaboratively on a project by having a central place where all work is stored, so any developer can see how their colleagues changes will affect their own and provide version control to allow unfavorable changes to be quickly and easily rolled back.

5. Define mobile-first design in your own words.

    Mobile-first is the development paradigm of creating a website for mobile first and then changing design and execution of the site by scaling it up for tablet and desktop users.
